    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AlterDatabase()
                .Annotation("Npgsql:Enum:appointment_status", "scheduled,in_progress,completed,cancelled")
                .Annotation("Npgsql:Enum:blood_type", "a_positive,a_negative,b_positive,b_negative,ab_positive,ab_negative,o_positive,o_negative")
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BloodGroup = table.Column<BloodType>(type: "blood_type", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecordDate = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
